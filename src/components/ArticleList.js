...
const ArticleList = (props) => {
    ...
    useEffect(() => {
        ...
        {"headline":"What Putin's End-Game May Be With Appeal To Ukraine Army, Call For Peace","link":"https://www.google.com/"},]} ).then(res => setArticles(res)).then(res =>{setIsLoaded(true)})
      }, [props.news.name])
  return (
    <div className='flex flex-col gap-y-12 w-[60%]'>
      {/* <ArticleListSkeleton /> */}
