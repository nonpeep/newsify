  ...
  return (
    <div id='App'>
      <div className="transition-colors delay-200 min-h-screen flex items-center flex-col bg-primary text-center dark:bg-accent-2">
          ...
          <div className='sm:m-5 m-3 sm:gap-x-10 gap-x-5 gap-y-5 transition-colors delay-200 flex flex-wrap sm:flex-nowrap  text-center items-center justify-centersm:w-max gap-2 flex-row'>
            <DarkMode/>
