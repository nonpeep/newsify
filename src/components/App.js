...
function App() {
  ...
  return (
    <div id='App'>
      <div className="transition-colors delay-200 flex items-center flex-col bg-primary text-center dark:bg-accent-2">
          <h1 className='transition-colors delay-200 text-6xl m-4 font-pop font-bold text-accent-2 dark:text-primary py-3 '>NEWSIFY</h1>
          <div className=' py-5 transition-colors delay-200 flex items-center justify-center w-max gap-2 flex-row'>
            <DarkMode/>
