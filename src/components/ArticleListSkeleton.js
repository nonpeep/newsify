    ...
    return (
      <div className=' animate-pulse flex flex-col max-w-[864px] m-5 gap-y-10'>
          <div className='transition-colors delay-200 w-full bg-secondary-shade dark:bg-accent-shade rounded-3xl'>
            <h1 className='transition-colors delay-200 lg:w-[816px] w-[80vw] h-[100px] bg-secondary hover:underline  dark:bg-accent-1 rounded-t-3xl font-mono text-3xl text-left p-5 font-bold text-accent-1 dark:text-primary leading-relaxed'></h1>
